...
d1 = loadImage("SVCProject/doc1.png")
d2 = loadImage("SVCProject/doc2.png")
d3 = loadImage("SVCProject/doc3.png")
...
canvas = createCanvas(displayWidth, displayHeight-150)
   ...
   ground2 = createSprite(70,displayHeight-20,displayWidth*6)
   
   /* PCLvl1 = createSprite(100, displayHeight-300, 10,10)
    PCLvl1.addImage(player1)
    PCLvl1.scale = 0.5 */
   
    PCLvl21 = createSprite(100, 20, 10,10)
    PCLvl21.addImage(player2)
    PCLvl21.scale = 0.5
   
    PCLvl22 = createSprite(120, 20, 10,10)
    PCLvl22.addImage(player2)
    PCLvl22.scale = 0.5
   
    PCLvl23 = createSprite(140, 20, 10,10)
    ...
    doc.addAnimation("doca",d1,d2,d3)
    doc.scale = 0.5
...
function cars(){
  if(frameCount%120===0){
    var y = random(700,displayHeight-300)
